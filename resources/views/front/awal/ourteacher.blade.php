...
<div class="site-block-half d-flex">
       <div class="image bg-image order-2" style="background-image: url(assets/front/images/person.jpg);"></div>
        <div class="text">
          <div class="section-heading text-left">
            <h2 class="mb-5">Samsul Bahri</h2>
            <p>Assalamualaikum, wr.wb
Alhamdulillahi Robbil alamin untuk semua teman-teman yang baru, selamat datang semuanya, selamat menjadi keluarga besar PPM NH ini, kami gembira bahwa kita semua disini adalah saudara lahir batin,</p>
            <p><a href="{{route('our_2')}}" class="text-uppercase">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
             <div class="site-block-half d-flex">
        <div class="image bg-image" style="background-image: url(assets/front/images/person.jpg);"></div>
        <div class="text">
          <div class="section-heading text-left">
            <h2 class="mb-5">Jaenudin</h2>
            <p>Assalamualaikum, wr.wb
Alhamdulillahi Robbil alamin untuk semua teman-teman yang baru, selamat datang semuanya, selamat menjadi keluarga besar PPM NH ini, kami gembira bahwa kita semua disini adalah saudara lahir batin,</p>
